...
<pre>Checker class biz.lermitage.sub.service.checker.impl.Adoptium8LinuxChecker failed, ignoring
java.io.IOException: Server returned HTTP response code: 504 for URL: https://api.adoptium.net/v3/assets/latest/8/hotspot?release=latest&jvm_impl=hotspot&vendor=adoptium&
	...
	at biz.lermitage.sub.service.checker.impl.AdoptiumChecker.check(AdoptiumChecker.kt:30)
