...
git add report/report.json report/report.md report/report-by-date.md report/report.rss.xml report/report.atom.xml report/report.properties report.uc.properties >> logs/git.log
git add report/status.md report/status.rss.xml report/status.atom.xml >> logs/git.log

git commit report/report.json report/report.md report/report-by-date.md report/report.rss.xml report/report.atom.xml  report/report.properties report.uc.properties report/status.md report/status.rss.xml report/status.atom.xml -m"autocommit by bot [ci skip]" >> logs/git.log
